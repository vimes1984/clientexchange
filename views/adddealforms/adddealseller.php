<div id="clientform">
	<h2>Seller Listing Setup</h2>
	<form class="standard-form" ng-class="{fadeing:true}" name="listform" ng-submit="submitform(listform)" method="POST" novalidate>
		<p>required = *</p>
		<div class="hiddenstuff">
			<input type="hidden" name="test1" ng-init="listobject.typeoflist = 'Selling'" value="Selling">
			<input type="hidden" name="test2" ng-init="accntype = 'Seller'">

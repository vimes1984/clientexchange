...
class clientexch{
	 ...
	 * @var      string
	 */
	protected $plugin_slug = "clientexch";
	...
	public function enqueue_admin_scripts() {
		...
		$screen = get_current_screen();
		if ($screen->id == $this->plugin_screen_hook_suffix) {
			wp_enqueue_script($this->plugin_slug . "-admin-script", plugins_url("js/clientexch-admin.js", __FILE__),
	...
	public function add_plugin_admin_menu() {
		$this->plugin_screen_hook_suffix = add_plugins_page(__("clientexch - Administration", $this->plugin_slug),
			__("clientexch", $this->plugin_slug), "read", $this->plugin_slug, array($this, "display_plugin_admin_page"));
	}
